                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #555; font-size: 14px; line-height: 1.6;">
                                Nous vous informons que votre compte <strong style="color: #d32f2f;">CAURIS DEGUE Callbreak</strong> a été <strong style="color: #c62828;">définitivement supprimé</strong> par notre équipe de modération.
                            </p>

                            <div style="margin: 20px 0; padding: 20px; background-color: #ffebee; border-left: 4px solid #d32f2f; border-radius: 4px;">
                                <p style="margin: 0 0 10px 0; color: #c62828; font-size: 13px; font-weight: bold;">
                                    ❌ Compte Supprimé
                                </p>
                                <p style="margin: 0; color: #555; font-size: 13px; line-height: 1.6;">
                                    Votre compte et toutes les données associées ont été supprimés de manière permanente. Vous ne pouvez plus accéder à la plateforme avec ce compte.
                                </p>
                            </div>
                            ...
                            <p style="margin: 20px 0 0 0; color: #555; font-size: 14px; line-height: 1.6;">
                                Si vous pensez qu'il s'agit d'une erreur ou si vous souhaitez contester cette décision, n'hésitez pas à nous contacter dans les plus brefs délais. L'équipe <strong>CAURIS DEGUE Callbreak</strong> est à votre disposition pour vous aider.
                            </p>

                            <div style="margin: 30px 0 0 0; padding: 20px; background-color: #fff3e0; border-left: 4px solid #ff9800; border-radius: 4px;">
                                <p style="margin: 0; color: #e65100; font-size: 13px;">
                                    ⚠️ <strong>Important :</strong> Cette action est irréversible. Si vous souhaitez faire appel, contactez-nous rapidement.
                                </p>
                            </div>
